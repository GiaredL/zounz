    ...
    <>
      <div className={styles.about}>
        ...
        <HeroSection>
          ...
          <p>
            <span style={{ fontWeight: 'bold' }}>Description:</span> The user will log in and by default appear on
            the charts page, which will display the top trending artists / bands in their selected area. Users will
            be able to set their area or explore the map and see the local artists that are trending in that area.
            Users will have their own profile, and will be able to upload music tracks for everyone's listening
            pleasure. You can think of it like soundcloud, but the songs and artists that appear are based on the
            local area. <br />
